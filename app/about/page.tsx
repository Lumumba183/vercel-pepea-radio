...
import { Radio, MapPin, Phone, Mail, Target, Eye, Heart, Award, Users, Globe, Music, Mic2, BookOpen, MessageCircle } from 'lucide-react'
      ...
      <main className="mt-[70px]">
        ...
        <section className="max-w-[800px] mx-auto px-6 py-16 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-[600px] mx-auto mb-6">
            <a href="tel:+254726846053" className="flex items-center justify-center gap-3 bg-[var(--card)] border border-[var(--border)] rounded-xl p-4 no-underline hover:border-blue-600 transition-all">
              <Phone className="text-success" size={20} />
              <span className="font-semibold text-[var(--text)]">+254 726 846 053</span>
            </a>
            <a href="https://wa.me/254726639789" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-[var(--card)] border border-[var(--border)] rounded-xl p-4 no-underline hover:border-green-600 transition-all">
