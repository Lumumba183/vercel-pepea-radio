...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Kenya\'s fastest-growing online radio station. Live streaming, news, sports, politics, and community stories.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                sameAs: [
                  'https://facebook.com/pepearadio',
                  'https://twitter.com/pepearadio',
                  'https://instagram.com/pepearadio',
                  'https://youtube.com/pepearadio',
                ],
                contactPoint: {
                  '@type': 'ContactPoint',
